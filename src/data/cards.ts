    ...
    options: [
      {
        ...
        deltas: { money: 0, health: -1, mood: 0, burnout: 0 },
      },
      {
        label: "Ресторан рядом",
        deltas: { money: -2, health: 1, mood: 2, burnout: -1 },
      },
      {
        label: "Съесть припасённый сэндвич",
        deltas: { money: 1, health: 0, mood: -1, burnout: 0 },
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        deltas: { money: 0, health: 2, mood: 0, burnout: -2 },
      },
      {
        label: "На афтепати с коллегами",
        deltas: { money: -1, health: -1, mood: 2, burnout: -1 },
      },
      {
        label: "Поработать в лобби отеля",
        deltas: { money: 0, health: -1, mood: -1, burnout: 2 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Батарейку",
        deltas: { money: 0, health: 0, mood: -10, burnout: 0 },
      },
      {
        label: "18 берёз",
        deltas: { money: 0, health: 0, mood: 2, burnout: -1 },
      },
    ],
  },
];
